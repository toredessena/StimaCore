...
struct SliderProvaComponentView: View {
 ...
 struct SliderProvaComponentView_Previews: PreviewProvider {
     static var previews: some View {
         SliderConservationComponent(sliderValueBinding: .constant(0.10), arc: -0.20...0.20, istep: 0.10, sliderValue: 0.10, colorComponent: "ColorPinkBright", qualityDescriptionText: "Incidenza")
     }
 }
